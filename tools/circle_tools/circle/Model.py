...
class Model(object):
    ...
    def OperatorCodes(self, j):
        ...
        if o != 0:
            ...
            from circle.OperatorCode import OperatorCode
            obj = OperatorCode()
    ...
    def Buffers(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from circle.Buffer import Buffer
            obj = Buffer()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def Metadata(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from circle.Metadata import Metadata
            obj = Metadata()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def SignatureDefs(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from circle.SignatureDef import SignatureDef
            obj = SignatureDef()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
...
import circle.Buffer
import circle.Metadata
import circle.OperatorCode
import circle.SignatureDef
import circle.SubGraph
try:
...
class ModelT(object):
    ...
    def __init__(self):
        ...
        self.operatorCodes = None  # type: List[circle.OperatorCode.OperatorCodeT]
        self.subgraphs = None  # type: List[circle.SubGraph.SubGraphT]
        self.description = None  # type: str
        self.buffers = None  # type: List[circle.Buffer.BufferT]
        self.metadataBuffer = None  # type: List[int]
        self.metadata = None  # type: List[circle.Metadata.MetadataT]
        self.signatureDefs = None  # type: List[circle.SignatureDef.SignatureDefT]
        ...
        if not model.OperatorCodesIsNone():
            ...
            for i in range(model.OperatorCodesLength()):
                if model.OperatorCodes(i) is None:
                    ...
                    operatorCode_ = circle.OperatorCode.OperatorCodeT.InitFromObj(model.OperatorCodes(i))
        ...
        if not model.SubgraphsIsNone():
            ...
            for i in range(model.SubgraphsLength()):
                if model.Subgraphs(i) is None:
                    ...
                    subGraph_ = circle.SubGraph.SubGraphT.InitFromObj(model.Subgraphs(i))
        ...
        if not model.BuffersIsNone():
            ...
            for i in range(model.BuffersLength()):
                if model.Buffers(i) is None:
                    ...
                    buffer_ = circle.Buffer.BufferT.InitFromObj(model.Buffers(i))
        ...
        if not model.MetadataIsNone():
            ...
            for i in range(model.MetadataLength()):
                if model.Metadata(i) is None:
                    ...
                    metadata_ = circle.Metadata.MetadataT.InitFromObj(model.Metadata(i))
        ...
        if not model.SignatureDefsIsNone():
            ...
            for i in range(model.SignatureDefsLength()):
                if model.SignatureDefs(i) is None:
                    ...
                    signatureDef_ = circle.SignatureDef.SignatureDefT.InitFromObj(model.SignatureDefs(i))
