...
class QuantizationParametersT(object):
    ...
    def __init__(self):
        ...
        self.details = None  # type: Union[None, circle.CustomQuantization.CustomQuantizationT]
    ...
    def _UnPack(self, quantizationParameters):
        ...
        self.details = circle.QuantizationDetails.QuantizationDetailsCreator(self.detailsType, quantizationParameters.Details())
