...
class SignatureDef(object):
    ...
    def Inputs(self, j):
        ...
        if o != 0:
            ...
            from circle.TensorMap import TensorMap
            obj = TensorMap()
...
class SignatureDefT(object):
    ...
    # SignatureDefT
    def __init__(self):
        self.inputs = None  # type: List[circle.TensorMap.TensorMapT]
        self.outputs = None  # type: List[circle.TensorMap.TensorMapT]
        ...
        if not signatureDef.InputsIsNone():
            ...
            for i in range(signatureDef.InputsLength()):
                if signatureDef.Inputs(i) is None:
                    ...
                    tensorMap_ = circle.TensorMap.TensorMapT.InitFromObj(signatureDef.Inputs(i))
        ...
        if not signatureDef.OutputsIsNone():
            ...
            for i in range(signatureDef.OutputsLength()):
                if signatureDef.Outputs(i) is None:
                    ...
                    tensorMap_ = circle.TensorMap.TensorMapT.InitFromObj(signatureDef.Outputs(i))
