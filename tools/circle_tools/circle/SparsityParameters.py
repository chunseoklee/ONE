...
class SparsityParameters(object):
    ...
    def DimMetadata(self, j):
        ...
        if o != 0:
            ...
            from circle.DimensionMetadata import DimensionMetadata
...
import circle.DimensionMetadata
try:
...
class SparsityParametersT(object):
    ...
    def __init__(self):
        ...
        self.dimMetadata = None  # type: List[circle.DimensionMetadata.DimensionMetadataT]
        ...
        if not sparsityParameters.DimMetadataIsNone():
            ...
            for i in range(sparsityParameters.DimMetadataLength()):
                if sparsityParameters.DimMetadata(i) is None:
                    ...
                    dimensionMetadata_ = circle.DimensionMetadata.DimensionMetadataT.InitFromObj(sparsityParameters.DimMetadata(i))
