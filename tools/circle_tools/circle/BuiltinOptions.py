...
def BuiltinOptionsCreator(unionType, table):
    ...
    if unionType == BuiltinOptions().RunModelOptions:
        import circle.RunModelOptions
        return circle.RunModelOptions.RunModelOptionsT.InitFromBuf(table.Bytes, table.Pos)
