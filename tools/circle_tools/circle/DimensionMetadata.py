...
import circle.Int32Vector
import circle.SparseIndexVector
import circle.Uint16Vector
import circle.Uint8Vector
try:
...
class DimensionMetadataT(object):
    ...
    def __init__(self):
        ...
        self.arraySegments = None  # type: Union[None, circle.Int32Vector.Int32VectorT, circle.Uint16Vector.Uint16VectorT, circle.Uint8Vector.Uint8VectorT]
        self.arrayIndicesType = 0  # type: int
        self.arrayIndices = None  # type: Union[None, circle.Int32Vector.Int32VectorT, circle.Uint16Vector.Uint16VectorT, circle.Uint8Vector.Uint8VectorT]
    ...
    def _UnPack(self, dimensionMetadata):
        ...
        self.arraySegments = circle.SparseIndexVector.SparseIndexVectorCreator(self.arraySegmentsType, dimensionMetadata.ArraySegments())
        self.arrayIndicesType = dimensionMetadata.ArrayIndicesType()
        self.arrayIndices = circle.SparseIndexVector.SparseIndexVectorCreator(self.arrayIndicesType, dimensionMetadata.ArrayIndices())
