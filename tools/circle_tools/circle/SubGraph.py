...
class SubGraphT(object):
    ...
    # SubGraphT
    def __init__(self):
        self.tensors = None  # type: List[circle.Tensor.TensorT]
        self.inputs = None  # type: List[int]
        self.outputs = None  # type: List[int]
        self.operators = None  # type: List[circle.Operator.OperatorT]
        ...
        if not subGraph.TensorsIsNone():
            ...
            for i in range(subGraph.TensorsLength()):
                if subGraph.Tensors(i) is None:
                    ...
                    tensor_ = circle.Tensor.TensorT.InitFromObj(subGraph.Tensors(i))
        ...
        if not subGraph.OperatorsIsNone():
            ...
            for i in range(subGraph.OperatorsLength()):
                if subGraph.Operators(i) is None:
                    ...
                    operator_ = circle.Operator.OperatorT.InitFromObj(subGraph.Operators(i))
