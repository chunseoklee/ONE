...
class RmsNormOptionsT(object):
    ...
    def Pack(self, builder):
        RmsNormOptionsStart(builder)
        RmsNormOptionsAddEpsilon(builder, self.epsilon)
        rmsNormOptions = RmsNormOptionsEnd(builder)
