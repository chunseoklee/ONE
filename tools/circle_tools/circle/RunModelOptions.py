...
def AddLocation(builder, location):
    RunModelOptionsAddLocation(builder, location)
...
def AddSignature(builder, signature):
    RunModelOptionsAddSignature(builder, signature)

def RunModelOptionsEnd(builder):
    return builder.EndObject()

def End(builder):
    return RunModelOptionsEnd(builder)
...
class RunModelOptionsT(object):
    ...
    def Pack(self, builder):
        ...
        if self.signature is not None:
            RunModelOptionsAddSignature(builder, signature)
        runModelOptions = RunModelOptionsEnd(builder)
